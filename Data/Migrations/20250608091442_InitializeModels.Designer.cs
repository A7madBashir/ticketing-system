...
namespace TicketingSystem.Data.Migrations
{
    ...
    [Migration("20250608091442_InitializeModels")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TicketingSystem.Models.Categorys.Category", b =>
                {
            ...
            modelBuilder.Entity("TicketingSystem.Models.Replys.Reply", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("character varying(26)");
            ...
            modelBuilder.Entity("TicketingSystem.Models.Subscriptions.Subscription", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("character varying(26)");
            ...
            modelBuilder.Entity("TicketingSystem.Models.Tickets.Ticket", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("character varying(26)");
            ...
            modelBuilder.Entity("TicketUser", b =>
                {
                    b.HasOne("TicketingSystem.Models.Tickets.Ticket", null)
                        .WithMany()
            ...
            modelBuilder.Entity("TicketingSystem.Models.Entities.Agency.Agency", b =>
                {
                    b.HasOne("TicketingSystem.Models.Subscriptions.Subscription", "Subscription")
                        .WithMany("Agencies")
            ...
            modelBuilder.Entity("TicketingSystem.Models.Replys.Reply", b =>
                {
                    b.HasOne("TicketingSystem.Models.Tickets.Ticket", "Ticket")
                        .WithMany("Replies")
            ...
            modelBuilder.Entity("TicketingSystem.Models.Tickets.Ticket", b =>
                {
                    ...
                    b.HasOne("TicketingSystem.Models.Categorys.Category", "Category")
                        .WithMany("Tickets")
